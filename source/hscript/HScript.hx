...
import hscript.HScriptUtil;
import hscript.CustomSubstate;
...
class HScript extends Iris
{
	...
	override function preset() {
		...
		set('getModSetting', function(saveTag:String, ?modName:String = null) {
			...
			return HScriptUtil.getModSetting(saveTag, modName);
		});
		...
		set('parentLua', null); // comment if it causes problems
		set('this', this);
		set('game', FlxG.state);
		set('controls', Controls.instance);

		set('buildTarget', HScriptUtil.getBuildTarget());
		set('customSubstate', CustomSubstate.instance);
		set('customSubstateName', CustomSubstate.name);

		set('Function_Stop', HScriptUtil.Function_Stop);
		set('Function_Continue', HScriptUtil.Function_Continue);
		set('Function_StopLua', HScriptUtil.Function_StopLua); //doesnt do much cuz HScript has a lower priority than Lua
		set('Function_StopHScript', HScriptUtil.Function_StopHScript);
		set('Function_StopAll', HScriptUtil.Function_StopAll);
	}
